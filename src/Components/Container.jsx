...
const Container = () => {
    return (
        ...
        <p class="items-center text-xl justify-center sm:text-xl mb-20 sm:justify-center text-center  sm:text-center"> Explore Our Platform to uncover the untapped potential
