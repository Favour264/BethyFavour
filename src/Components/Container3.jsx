 ...
 export const Container3 = () =>{
    return(
        <div class=" flex flex-col sm:flex-row ">
          <h1 class="font-light sm:text-4xl text-2xl  text-gray-500 ml-10">
          ...
          <div class="w-4/6 sm:w-2/5 h-30 sm:h-40 text-white bg-purple-800 sm:ml-10 ml-5 rounded-2xl ">
          ...
          <div class="w-4/6 sm:w-2/5 h-30 sm:h-40 text-white bg-pink-600 sm:ml-10 ml-5 rounded-2xl ">
          ...
          <div class="w-4/6 sm:w-2/5 h-30 sm:h-40 text-white bg-green-500 sm:ml-10 ml-5 rounded-2xl ">
          ...
          <div class="w-4/6 sm:w-2/5 h-30 sm:h-40 text-white bg-black sm:ml-10 ml-5 rounded-2xl ">
