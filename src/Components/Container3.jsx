...
import { faGreaterThan } from '@fortawesome/free-solid-svg-icons';
 ...
 export const Container3 = () =>{
    return(
        <div class=" flex  ">
          <h1 class="font-light sm:text-4xl text-3xl  text-gray-500 ml-10">
          ...
          <div class="w-6/6 sm:w-2/5 h-30 sm:h-40 text-white bg-purple-800 sm:ml-10 ml-5 rounded-2xl ">
          ...
          class="w-8 sm:w-7 h-8 sm:h-7 rounded-full bg-white text-purple-800 float-right mr-5" />
          </div>

          <div class="w-6/6 sm:w-2/5 h-30 sm:h-40 text-white bg-pink-600 sm:ml-10 ml-5 rounded-2xl ">
          ...
          <div class="w-6/6 sm:w-2/5 h-30 sm:h-40 text-white bg-green-500 sm:ml-10 ml-5 rounded-2xl ">
          ...
          <div class="w-6/6 sm:w-2/5 h-30 sm:h-40 text-white bg-black sm:ml-10 ml-5 rounded-2xl ">
