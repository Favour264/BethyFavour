 ...
 export const Container3 = () =>{
    return(
        <div class=" flex flex-col sm:flex-row ">
          ...
          <div class="w-4/6 sm:w-2/5 h-30 sm:h-40 text-white bg-purple-800 mt-5 mb:ml-5 sm:ml-10  lg:ml-5 ml-20 rounded-2xl ">
          ...
          <div class="w-4/6 sm:w-2/5 h-30 sm:h-40 text-white bg-pink-600  sm:ml-10  lg:ml-5 ml-20 rounded-2xl ">
          ...
          <div class="w-4/6 sm:w-2/5 h-30 sm:h-40 text-white bg-green-500  sm:ml-10  lg:ml-5 ml-20 rounded-2xl ">
          ...
          <div class="w-4/6 sm:w-2/5 h-30 sm:h-40 text-white bg-black sm:ml-10   lg:ml-5 ml-20 rounded-2xl ">
