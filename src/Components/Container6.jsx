...
<div className="flex flex-col sm:flex-row ">
  <div className="flex-row  mr-5 sm:mr-20">
        <h3 className=' text-4xl sm:text-5xl font-thin text-gray-500 ml-10 lg:ml-20 md:ml-20 sm:ml-20'>Latest <br/> Articles</h3><br/>
  ...
  <div className="flex flex-col sm:flex-row float-right gap-3 sm:gap-5 ">
    <div className="flex-col sm:flex-row">
        <div className="w-80 bg-white border-2 border-gray-400 ml-3 lg:ml-0 md:ml-0 sm:ml-0  mr-0 sm:mr-20 mb-5 sm:mb-20">
        ...
        <div className="w-80 bg-white border-2 border-gray-400 ml-3 lg:ml-0 md:ml-0 sm:ml-0 mb-10 sm:mb-20">
            <img  className="w-80 object-cover" src={photo1} alt="Picture" />
            <div className="p-2">
    ...
    <div className="flex-col sm:flex-row">
        <div className="w-80 bg-white border-2 border-gray-400 ml-3 lg:ml-0 md:ml-0 sm:ml-0 sm:mr-20 mr-0  sm:mb-20 mb-10 ">
            <img  className="w-80 object-cover" src={photo1} alt="Picture" />
            <div className="p-2">
        ...
        <div className="w-80 bg-white border-2 border-gray-400 ml-3 lg:ml-0 md:ml-0 sm:ml-0 mb-5">
            <img  className="w-80 object-cover" src={photo1} alt="Picture" />
            <div className="p-2">
