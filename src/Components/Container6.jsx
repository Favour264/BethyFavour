...
<div className="flex flex-col sm:flex-row ">
  <div className="flex-row  mr-5 sm:mr-20">
        ...
        <button className='bg-green-700 p-2 sm:p-4 ml-5 sm:ml-20 mt-10 rounded-xl text-white sm:w-40 w-30'>See more</button>
  </div>
  <div className="flex flex-col sm:flex-row float-right gap-3 sm:gap-5 ">
    <div className="flex-col sm:flex-row">
        <div className="w-80 bg-white border-2 border-gray-400  mr-0 sm:mr-20 mb-5 sm:mb-20">
        ...
        <div className="w-80 bg-white border-2 border-gray-400 mb-10 sm:mb-20">
            <img  className="w-80 object-cover" src={photo1} alt="Picture" />
            <div className="p-2">
    ...
    <div className="flex-col sm:flex-row">
        <div className="w-80 bg-white border-2 border-gray-400 sm:mr-20 mr-0  sm:mb-20 mb-10 ">
            <img  className="w-80 object-cover" src={photo1} alt="Picture" />
            <div className="p-2">
        ...
        <div className="w-80 bg-white border-2 border-gray-400 ">
            <img  className="w-80 object-cover" src={photo1} alt="Picture" />
            <div className="p-2">
